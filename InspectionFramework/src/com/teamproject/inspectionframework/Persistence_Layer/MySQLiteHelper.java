...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	private static final String CREATE_TABLE_ATTACHMENTS = "CREATE TABLE " + TABLE_ATTACHMENTS + "(" + AT_COLUMN_ROWID + " INTEGER, " + AT_COLUMN_ATTACHMENT_ID + " TEXT PRIMARY KEY UNIQUE, " + AT_COLUMN_FILE_TYPE + " TEXT, " + AT_COLUMN_BINARY_OBJECT + " TEXT, " + AT_COLUMN_FK_ASSIGNMENT_ID + " TEXT, " + AT_COLUMN_FK_TASK_ID + " TEXT, " + " FOREIGN KEY(fkTaskId) REFERENCES TABLE_TASKS(taskId))";
